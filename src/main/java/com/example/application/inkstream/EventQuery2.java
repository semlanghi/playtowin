...
public class EventQuery2<O> implements RSPQL<O> {
    ...
    public EventQuery2(String id, DataStream<Graph> stream, Time time, WindowNode win, VarOrTerm s, VarOrTerm p, VarOrTerm o, RelationToStreamOperator<Binding, O> r2s) {
        this.id = id;
    ...
    public EventQuery2(String id, DataStream<Graph> stream, Time time, WindowNode win, List<TripleHolder> triplePatterns, RelationToStreamOperator<Binding, O> r2s) {
        this(id, stream, time, win, Map.of("", triplePatterns), r2s);
    }

    public EventQuery2(String id, DataStream<Graph> stream, Time time, WindowNode win, Map<String, List<TripleHolder>> triplePatterns, RelationToStreamOperator<Binding, O> r2s) {
        this.id = id;
        this.outputStream = new DataStreamImpl<O>(id);
    ...
    public EventQuery2(String id, DataStream<Graph> stream, Time time, WindowNode win, Map<String, List<TripleHolder>> triplePatterns, RelationToStreamOperator<Binding, O> r2s, String defaultGraphIRI) {
