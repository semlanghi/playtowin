...
public class R2RConsistencyAnnotatorElectric<V> implements RelationToRelationOperator<Relation<EventBean<V>>,AnnotatedRelation<EventBean<V>>> {
    ...
    public R2RConsistencyAnnotatorElectric(long windowSize, long windowSlide, ConstraintFactory<EventBean<V>> constraintFactory) {
